module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            demo_js: {
                ...
                files: {
                    '<%= meta.assets_minified_root %>demo-widgets.js': [
                    ...
                    '<%= meta.assets_root %>/widgets/skycons/skycons.js',
                    '<%= meta.assets_root %>/widgets/content-box/contentbox.js',
                    '<%= meta.assets_root %>/widgets/tabs/tabs.js',
                    '<%= meta.assets_root %>/widgets/sparklines/sparklines.js',
                    '<%= meta.assets_root %>/widgets/sparklines/sparklines-demo.js',
                    '<%= meta.assets_root %>/widgets/slidebars/slidebars.js',
                    '<%= meta.assets_root %>/widgets-init.js',
                    '<%= meta.assets_root %>/themes/supina/js/layout.js'
                    ]
                }
        ...
        cssmin: {
            ...
            demo_css: {
                files: {
                    '<%= meta.assets_minified_root %>demo-widgets.css': [
    ...
    grunt.registerTask('all', [
        'clean', 'assemble', 'concat', 'uglify', 'cssmin', 'copy', 'dom_munger', 'htmlmin', 'watch'
    ]);
