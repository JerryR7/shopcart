<header class="no-padding-bottom header-alt">
    <div class="container no-padding">
        ...
        <div class="col-xs-12 col-md-3 logo-holder">
            <!-- ============================================================= LOGO ============================================================= -->
<div class="logo">
    <?php echo anchor('','<svg width="233px" height="54px" viewBox="0 0 233 54" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
<div class="col-xs-12 col-md-6 top-search-holder no-margin">
    <div class="contact-row">
        <div class="phone inline">
            <i class="fa fa-phone"></i> (+886) 22 002 542
        </div>
        <div class="contact inline">
            <i class="fa fa-envelope"></i> cherub0526@<span class="le-color">livemail.tw</span>
        </div>
    </div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
...
<div class="col-xs-12 col-md-3 top-cart-row no-margin">
    ...
    <div class="wishlist-compare-holder">
        <div id="top_favor" class="wishlist ">
            <?php echo anchor('shopcart/favor','<i class="fa fa-heart"></i>喜歡商品<span class="value">(' . $this->favor->total_articles() . ')</span>');?>
        </div>
        <div id="top_compare" class="compare">
            <?php echo anchor('shopcart/compare','<i class="fa fa-exchange"></i>比較商品<span class="value">(' . $this->compare->total_articles() . ')</span>');?>
        </div>
    </div>
