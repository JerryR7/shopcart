<div id="single-product">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                    <img class="img-responsive" alt="" src="<?php echo base_url();?>assets/images/blank.gif" data-echo="<?php echo base_url();?>assets/images/products/product-gallery-01.jpg" />
                </a>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                    <img width="67" alt="" src="<?php echo base_url();?>assets/images/blank.gif" data-echo="<?php echo base_url();?>assets/images/products/gallery-thumb-01.jpg" />
                </a>
    ...
    <div class="body">
        ...
        <div class="availability"><label>商品狀況:</label><span class="available">  有貨</span></div>
    ...
    <div class="container">
        <div class="tab-holder">
            ...
            <ul class="nav nav-tabs simple" >
                <li class="active"><a href="#description" data-toggle="tab">簡介</a></li>
                <li><a href="#additional-info" data-toggle="tab">附加資訊</a></li>
                <li><a href="#reviews" data-toggle="tab">回應 (3)</a></li>
            </ul><!-- /.nav-tabs -->
