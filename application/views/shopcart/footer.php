    ...
    <div class="sub-form-row">
        <div class="container">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 no-padding">
                <?php echo form_open('shopcart/add_newsletter');?>
                <input id="newsletter" type="email" name="email" placeholder="訂閱我們的電子報">
                <button id="submit_newsletter" class="le-button">確認</button>
                <?php echo form_close();?>
            </div>
        </div>
    </div>
